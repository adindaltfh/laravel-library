...
@section('content')
    ...
    <div class="flex items-center mb-2">
        ...
        <div>
            <p class="mt-1 mb-0 text-l font-semibold leading-tight" style="margin-left:8px;">Administrasi</p>
            <h4 class="font-bold" style="margin-left:8px;">5</h4>
        </div>
    </div>
</div>
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div class="flex items-center mb-2">
                        <div class="flex items-center justify-center text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-to-tl from-blue-600 to-cyan-400 text-neutral-900" style="width: 55px; height:55px;">
                        <svg width="45px" height="45px" viewBox="-20 -20 80 80" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div>
                        <p class="mt-1 mb-0 text-l font-semibold leading-tight" style="margin-left:8px;">Pemasaran</p>
                      <h4 class="font-bold" style="margin-left:8px;">4</h4>
                        </div>
                    </div>
                    </div>
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div class="flex items-center mb-2">
                        <div class="flex items-center justify-center w-11 h-11 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-to-tl from-red-500 to-yellow-400 text-neutral-900" style="width: 55px; height:55px;">
                            <svg width="45px" height="45px" viewBox="-20 -20 80 80" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div>
                        <p class="mt-1 mb-0 text-l font-semibold leading-tight"">Keuangan</p>
                      <h4 class="font-bold" >3</h4>
                        </div>
                      </div>
                    </div>
                    <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0" >
